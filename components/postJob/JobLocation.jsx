  ...
  return (
    <div className="py-4">
        <div class="flex">
            ...
            <div id="dropdown-states" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow " styles="position: absolute; inset: auto auto 0px px; margin: 80px; transform: translate(318px, 2306px);" data-popper-reference-hidden="" data-popper-escaped="" data-popper-placement="top">
                <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="states-button">
                    <li>
                        <button type="button" class="inline-flex py-2 px-4 w-full text-sm text-gray-700 hover:bg-blue-500 bg-gray-100 hover:text-white">
                    ...
                    <li>
                        <button type="button" class="inline-flex py-2 px-4 w-full text-sm text-gray-700 hover:bg-blue-500 hover:text-gray-100 ">
                            <div class="inline-flex items-center">
                    ...
                    <li>
                        <button type="button" class="inline-flex py-2 px-4 w-full text-sm text-gray-700 hover:bg-gray-100 ">
                            <div class="inline-flex items-center">
                                <svg class="h-3.5 w-3.5 rounded-full mr-2" xmlns="" id="flag-icon-css-it" viewBox="0 0 512 512">
                                    <g fill-rule="evenodd" stroke-width="1pt"><path fill="#fff" d="M0 0h512v512H0z"></path>
                                    <path fill="#009246" d="M0 0h170.7v512H0z"></path>
                                    <path fill="#009246" d="M341.3 0H512v512H341.3z"></path>
            ...
            <select id="states" class="bg-gray-50 border border-gray-300 text-gray-500 text-sm rounded-r-lg border-l-gray-50 border-l-2 focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  placeholder-gray-100 ">
