...
const Footer = () => {
  return (
    <div class="p-[5rem] dark:bg-[#007eb9]">
        ...
        <footer class="p-4 sm:p-6 ">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com/" class="flex items-center">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">IzzyConnect</span>
                    </a>
                    <div class="flex pt-[2rem] mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                ...
                <div class="text-sm text-gray-500 sm:text-center dark:text-white">© 2022 <a href="https://flowbite.com/" class="hover:underline">IzzyConnect</a>. All Rights Reserved. </div>
